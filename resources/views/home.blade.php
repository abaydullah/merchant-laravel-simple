                ...
                <div class="py-12">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            ...
                            <h3 class="py-3 px-6 text-3xl bg-gray-50">{{$category->name}}</h3>
                            <div class="p-6 text-gray-900">

                                <div>
                                    <ul class="space-y-3 divide-4 bg-gray-50 ">
                                        @foreach($products as  $product)
                                            <div class="py-4 px-6 space-y-4">
                                                <h2 class="text-2xl">{{$product->name}}</h2>
                                                <div>
                                                    Category: <a class="bg-gray-50 hover:bg-green-300 hover:text-white py-2 px-3 rounded-md font-semibold"
                                                       href="{{route('merchant.category',$product->category->slug,false)}}">{{$product->category->name}}</a>
                                                </div>
